...
class NameScorer:
    ...
    def _common_prefix_length(self, s1: str, s2: str) -> int:
        ...
        for i in range(min(len(s1), len(s2))):
            if s1[i] == s2[i]:
                ...
                break
        return min(prefix_len, 4)  # Limit to 4 characters
    ...
    def _cosine_similarity(self, name1: str, name2: str) -> float:
        """Calculate similarity using cosine similarity of character n-grams"""
        if name1 == name2:
            return 100.0
    ...
    def _get_character_bigrams(self, text: str) -> dict:
        """Get character bigrams with their frequencies"""
        bigrams = {}
    ...
    def _hybrid_similarity(self, name1: str, name2: str) -> float:
        """Calculate similarity using a combination of algorithms"""
        if name1 == name2:
            return 100.0
        ...
        # Weighted average (can be adjusted based on performance)
